...
TRAIN_FILE = os.path.join(DATA_FOLDER, f"completion_train_final_scanpath.jsonl")
VALID_FILE = os.path.join(DATA_FOLDER, f"completion_valid_final_scanpath.jsonl")
MAX_LENGTH = 1024
