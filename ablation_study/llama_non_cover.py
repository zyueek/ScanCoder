...
DATA_FOLDER = "./"
OUTPUT_DIR = f"./{MODEL_NAME}_advanced_final_{TASK}_non_cover"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Llama model for code completion with scanpath augmentation")
